...
def tiff2nc(path):
    ...
    inp=im_data#np.ones([im_data.shape[0],im_data.shape[1]],dtype='float32')*3
...
day_nc = tiff2nc(r"G:\data_FLOOD\soil\cal\Ksaturated_layer2.tif")
path=r'D:\tensorflow\lisflood\shanghai\maps'
day_nc.to_netcdf(path+'/ksat2_o.nc',encoding={
            'value':{
            '_FillValue':-9999}
        })
