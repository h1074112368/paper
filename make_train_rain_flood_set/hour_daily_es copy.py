...
def tiff2nc(path,dt):
    ...
    #     inp[i * interval:(i + 1) * interval] = set[i]/interval
    # inp[inp<0]=0
    ds = xr.Dataset({
        'x': (['x'], im_lon, lon_attr),
        'y': (['y'], im_lat, lat_attr),
...
def esToNc(start, end, dt):
    ...
    day_nc = tiff2nc('/home/hyc/flaskFiles/floodBase/landUseAddWudingAddwater.tif',dt)
    path=f'/home/hyc/shanghai/meteo/hour_es.nc'
...
if __name__ == '__main__':
    ...
    esToNc('2021-07-23 00','2021-07-24 00',1)
