...
def tiff2nc(path,rain):
    ...
    laea_attr=dict()
    time_data=pd.date_range('2021-07-23 00','2021-07-23 02', freq=f"5T")
    inp = im_data
    ...
    return ds
def prToNc(rain=[20]*24):
    import  netCDF4 as nc
    import os
   
    
    day_nc = tiff2nc('/home/hyc/flaskFiles/floodBase/dem_shanghai_25m_tianwa.tif',rain)
    path=f'/home/hyc/shanghai/dem.nc'
