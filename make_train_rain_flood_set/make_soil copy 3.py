...
def layer2(thickness2):
    ...
    for ii in range(thickness2.shape[0]):
        for jj in range(thickness2.shape[1]):
            for kk in range(int(5),int(5+thickness2[ii,jj])):
                if kk<=dept[1]:
            ...
            Thetas_sum[ii,jj]/=thickness2[ii,jj]
            Thetar_sum[ii,jj]/=thickness2[ii,jj]
            Lamba_sum[ii,jj]/=thickness2[ii,jj]
            Alpha_sum[ii,jj]/=thickness2[ii,jj]
