...
from keras.layers import Dense, Conv2D, Flatten, BatchNormalization, Activation,Dropout,Reshape
model = Sequential()
model.add(Conv2D(32*2, kernel_size=1, input_shape=(64,64, 27)))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Conv2D(128*2, kernel_size=1))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Flatten())
model.add(Dense(32*2, kernel_initializer='random_uniform'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Dropout(0.2))
model.add(Dense(256*2,kernel_initializer='random_uniform'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Dropout(0.2))
...
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Dense(24*64*64))
model.add(Reshape((24,64,64)))
...
import os
# if(os.path.exists("/home/hyc/swin/swin/CNN.keras")):
#     os.unlink("/home/hyc/swin/swin/CNN.keras")
# # keras.saving.save_model(model,"/home/hyc/swin/swin/CNN.keras")
# keras.saving.save_model(model,"/home/hyc/swin/swin/CNN.keras")
# model.save_weights("/home/hyc/swin/swin/CNN_save_weights.weights.h5")
model.load_weights("/home/hyc/swin/swin/CNN_save_weights.weights.h5")
...
np.save("/home/hyc/swin/swin/yuce_cnn.npy",result[207+600])
np.save("/home/hyc/swin/swin/shiji_cnn.npy",y_test[207+600])
