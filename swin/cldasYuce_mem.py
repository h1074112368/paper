...
import os
if os.path.exists('/home/hyc/swin/swin/index_cldas_mem.npy'):
    os.remove('/home/hyc/swin/swin/index_cldas_mem.npy')
np.save('/home/hyc/swin/swin/index_mem.npy',index)
...
import os
if(os.path.exists("/home/hyc/swin/swin/my_model_cldas_mem.keras")):
    os.unlink("/home/hyc/swin/swin/my_model_cldas_mem.keras")
keras.saving.save_model(model,"/home/hyc/swin/swin/my_model_cldas_mem.keras")
model.save_weights("/home/hyc/swin/swin/my_model_save_weights_cldas.weights_mem.h5")
