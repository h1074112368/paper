...
import os
if(os.path.exists("/home/hyc/swin/swin/my_model_cldas.keras")):
    os.unlink("/home/hyc/swin/swin/my_model_cldas.keras")
keras.saving.save_model(model,"/home/hyc/swin/swin/my_model_cldas.keras")
model.save_weights("/home/hyc/swin/swin/my_model_save_weights_cldas.weights.h5")
