...
model.load_weights("/home/hyc/swin/swin/my_model_save_weights.weights.h5")
...
for i in range(len(result)):
    print(i,mse(result[i,:,32,32],y_test[i,:,32,32]))
    # for j in range(24):
    #     print(result[16][j][32][32],y_test[16][j][32][32])
rain_set=np.load("/home/hyc/flaskFiles/make_train_rain_flood_set/rainfall_set.npy")
import pandas as pd
index=292
pd.DataFrame([rain_set[3000-720+index],result[index,:,32,32],y_test[index,:,32,32]]).to_excel(f"/home/hyc/swin/swin/result_{index}.xlsx")   
