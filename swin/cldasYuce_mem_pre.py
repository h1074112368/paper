...
# for nan_i in range(7):
#     datasetload[nan_i][np.isnan(datasetload[nan_i])]=np.median(datasetload[nan_i])
#     print(np.median(datasetload[nan_i]))
...
for i in range(7):
    ...
    # min_=np.min(datasetload[i][datasetload[i]!=0])
...
import os
if os.path.exists('/home/hyc/swin/swin/index_cldas_mem_pre.npy'):
    os.remove('/home/hyc/swin/swin/index_cldas_mem_pre.npy')
np.save('/home/hyc/swin/swin/index_mem_pre.npy',index)
...
earlystop_callback = keras.callbacks.EarlyStopping(monitor='loss', min_delta=0.003,patience=3,restore_best_weights=True)
history = model.fit(
    dataset,
...
import os
if(os.path.exists("/home/hyc/swin/swin/my_model_cldas_mem_pre.keras")):
    os.unlink("/home/hyc/swin/swin/my_model_cldas_mem_pre.keras")
keras.saving.save_model(model,"/home/hyc/swin/swin/my_model_cldas_mem_pre.keras")
model.save_weights("/home/hyc/swin/swin/my_model_save_weights_cldas_mem_pre.weights.h5")
