...
import os
if os.path.exists('/home/hyc/swin/swin/index_cldas_mem_tmp.npy'):
    os.remove('/home/hyc/swin/swin/index_cldas_mem_tmp.npy')
np.save('/home/hyc/swin/swin/index_mem_tmp.npy',index)
...
import os
if(os.path.exists("/home/hyc/swin/swin/my_model_cldas_mem_tmp.keras")):
    os.unlink("/home/hyc/swin/swin/my_model_cldas_mem_tmp.keras")
keras.saving.save_model(model,"/home/hyc/swin/swin/my_model_cldas_mem_tmp.keras")
model.save_weights("/home/hyc/swin/swin/my_model_save_weights_cldas_mem_tmp.weights.h5")
