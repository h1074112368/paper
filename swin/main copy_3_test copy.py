...
for i in range(len(result)):
    # print("r2",r2(result[i],y_test[i]))
    res=r2(result[i],y_test[i])
    if res<0.998:
        print(i,res)
    if minr2>res:
        minr2=res
        minr2i=i
        print(minr2,i)
np.save("/home/hyc/swin/swin/yuce.npy",result[207+600])
np.save("/home/hyc/swin/swin/shiji.npy",y_test[207+600])
