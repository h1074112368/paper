...
# dataseterr=load_pickle("cldasdataerr.npy")
# uniqueindex=np.unique([i[0] for i in dataseterr])
# uniqueindex.sort()
...
for i in range(len_index):
    np.save(f"/mnt/data2/hyc/tfrecord/x_{'{:04d}'.format(i)}.npy",data_x[i])
    np.save(f"/mnt/data2/hyc/tfrecord/y_{'{:04d}'.format(i)}.npy",data_y[i])
