...
pd.DataFrame(rain_set).to_excel(f"/home/hyc/swin/swin/result_rain_set.xlsx")   
...
np.save("/home/hyc/swin/swin/yuce.npy",result[6])
np.save("/home/hyc/swin/swin/shiji.npy",y_test[6])
...
#     for j in range(24):
#         print(result[i][j][32][32],y_test[i][j][32][32])
